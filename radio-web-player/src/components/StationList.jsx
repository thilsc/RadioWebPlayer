...
const StationList = ({ stations, currentStation, onSelectStation, onFilterByGenre, currentCountry }) => {
  return (
        ...
        {stations.map((station) => (
          ...
          >
            ...
            <div className="station-item-info">
              ...
              <span 
                className="station-item-genre"
                onClick={(e) => {
                  e.stopPropagation();
                  if (onFilterByGenre && station.genre) {
                    onFilterByGenre(station.genre, currentCountry);
                  }
                }}
                title={`Filtrar por ${station.genre}`}
              >
                {station.genre}
              </span>
            </div>
